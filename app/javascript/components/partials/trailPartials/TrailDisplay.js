            ...
            <div className="trail-profile-image-wrapper">
              ...
              {props.logged_in &&
                <Button
                  ...
                  style={{ backgroundColor: favorited ? "#1ba274" : "gray", border: "3px solid white" }}
              ...
              {props.logged_in &&
                <div className="trails-profile-questionnaire-wrapper">
                  <div style={{ display: "flex" }}>
                    <NavLink to={`/trails/${props.params_id}/questionnaire`} render >
                      <Button className="trail-profile-questionnaire-button">Contribute Trail Information</Button>
                    </NavLink>
                  </div>
                  <div style={{ display: "flex" }}>
                    <p onClick={toggle} className="trail-profile-questionnaire-label">Why contribute information to a trail?</p>
                  </div>
                </div>
              }
            </div>

            <Modal className="trail-profile-modal" isOpen={modal} toggle={toggle}>
              <ModalBody>
                <strong>Make the outdoors more accessible to others by contributing what you know!</strong><br/><br/>Please contribute information about a trail to help people with accessibility issues gain more knowledge about the trails that is otherwise not provided on other sites.<br/><br/>Since every person is different, we can't tell you how difficult a trail may be for you, but we aim to gather enough information about a trail to help you make an informed decision.
              </ModalBody>
              <ModalFooter>
                <Button className="trail-profile-modal-button" onClick={toggle}>Got it!</Button>{' '}
              </ModalFooter>
            </Modal>
          </>
        }
